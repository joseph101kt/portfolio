...
const HeroSection = () => {
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-5 pb-8 pt-8 sm:px-8">
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-20 items-start">
          ...
          <div className="max-w-2xl">
            ...
            {/* The Agitation */}
            <p 
              className="text-lg sm:text-xl leading-[1.5] mb-8"
              style={{ color: '#636E72' }}
            >
              When someone searches "plumber near me"—your competitor shows up first. 
...
<div className="lg:sticky lg:top-0 self-start">
    <div className="bg-white p-6 rounded-lg border border-[#E8DFD1] shadow-sm">
              ...
              {/* Competitor 1 - Faded */}
              <div className="px-3 py-2 mb-2 rounded opacity-35" style={{ backgroundColor: '#FAF7F2' }}>
              ...
              {/* Competitor 2 - Faded */}
              <div className="px-3 py-2 rounded opacity-35" style={{ backgroundColor: '#FAF7F2' }}>
                <p className="text-sm font-semibold text-blue-600 line-through mb-0.5">
                  Smith Plumbing
                </p>
                <p className="text-xs" style={{ color: '#636E72' }}>
              ...
              {/* Bottom Line */}
              <div className="mt-2 pt-2 border-t text-center" style={{ borderColor: '#E8DFD1' }}>
